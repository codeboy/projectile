...
env.hosts = ['c300.example.com']
env.code_dir = '/srv/www/c300'
env.virtualenv = '/srv/www/c300/.virtualenv'
env.code_repo = 'git@github.com:user/c300.git'
env.django_settings_module = 'c300.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/c300/wsgi.py" % env.code_dir)
